      ...
      {imgSrc ? (
        <div className="w-full h-full relative overflow-hidden border border-red-950/40 rounded flex items-center justify-center bg-black/40">
          <img
            ...
            className="w-full h-full object-contain filter drop-shadow-[0_0_15px_rgba(239,68,68,0.25)] brightness-75 contrast-125"
          />
        ...
        <svg
          ...
          className="w-full h-full filter drop-shadow-[0_0_15px_rgba(239,68,68,0.15)]"
        >
          ...
          {/* Hollow eye glint */}
          <circle cx="162" cy="177" r="2" fill="#ef4444" />
          <circle cx="238" cy="177" r="2" fill="#ef4444" />
          ...
          <line x1="40" y1="250" x2="110" y2="250" stroke="#ef4444" strokeWidth="0.5" strokeDasharray="3 3; 1 1" opacity="0.6"/>
          <line x1="290" y1="250" x2="360" y2="250" stroke="#ef4444" strokeWidth="0.5" strokeDasharray="3 3; 1 1" opacity="0.6"/>
          <circle cx="200" cy="50" r="4" stroke="#ef4444" strokeWidth="1" fill="none" />
          <line x1="200" y1="10" x2="200" y2="40" stroke="#ef4444" strokeWidth="1" strokeDasharray="2 2" />
