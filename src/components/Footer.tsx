      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <nav aria-label="Footer community links">
            <ul className="space-y-2.5">
              {[
                { label: "Discord", href: "#", Icon: DiscordIcon, color: "#5865F2" },
                { label: "LinkedIn", href: "#", Icon: LinkedInIcon, color: "#0A66C2" },
                { label: "Instagram", href: "#", Icon: InstagramIcon, color: "#E1306C" },
                { label: "X (Twitter)", href: "#", Icon: XIcon, color: "#e4e4e7" },
                { label: "GitHub", href: "#", Icon: GitHubIcon, color: "#e4e4e7" },
                ...
                <li key={label}>
                  ...
                  >
                    <span
                      ...
                      onMouseLeave={(e) => (e.currentTarget.style.color = "rgb(63 63 70)")}
                    >
                      <Icon />
                    </span>
                    {label}
        ...
        <div className="space-y-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-3 py-2 rounded transition-all group"
            style={{
